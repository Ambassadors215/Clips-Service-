...
export const CITY_COPY = {
  manchester: {
    ...
    intro: `Manchester has one of the UK’s richest African, Caribbean and Asian high streets — from Longsight and Rusholme to Cheetham Hill and beyond. Clip Services helps you find independent grocers, salons and fabric sellers online: order for collection or delivery where sellers offer it, with Stripe-secure payments and WhatsApp updates.`,
  },
  london: {
    display: "London",
    ...
    intro: `London’s diaspora communities span every borough — from Brixton and Peckham to Southall, Green Street and Wembley. Clip Services brings together independent African, Caribbean and Asian stores so you can browse authentic products, support local traders, and checkout securely without hunting through dozens of apps.`,
  },
  birmingham: {
    display: "Birmingham",
