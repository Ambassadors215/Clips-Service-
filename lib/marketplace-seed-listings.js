...
We cheer for Lagos spice runs and Kumasi breakfasts all the same window. Checkout on Clip mirrors the counter chatter you already know — simple swaps, receipts you can screenshot, Stripe when you prefer card over cash.` +
    ...
    {
      id: "seed-caribbean-roots-moss-side-mcr",
      email: "orders+caribbean.roots.seed@clipservice.app",
      role: "Caribbean Roots",
      bio:
        `Moss Side afternoons smell like Scotch bonnets and wet jerk paste here. We stack hard dough beside sorrel concentrates because Christmas and Sunday dinner share the same counter.
Saltfish tins sit next to ripe plantains tagged for frying or steaming on purpose.` +
      ...
      openingHours: `Moss Side, Manchester · ${hours}`,
    ...
    {
      id: "seed-bismillah-halal-foods-rusholme-mcr",
      email: "orders+bismillah.seed@clipservice.app",
      role: "Bismillah Halal Foods",
      bio:
        `The Curry Mile corridor knows this counter for chilled lamb diced to order and basmati sacks that fluff instead of clamping shut. Ghee jars gleam beside turmeric scoops scooped politely with tongs.` +
      ...
      applicationStatus: "approved",
      pilotBadge: "Pilot — Onboarding",
      heritageTags: ["South Asian", "Halal"],
      whatsappPhone: "+447830001103",
      openingHours: `Rusholme (Curry Mile), Manchester · ${hours}`,
      ...
      storeProducts: [
        ...
        {
          id: "p7",
          name: "Naan & chapatti atta flour (10 kg sack)",
          price: 13.49,
          category: "staples-grains",
          thumbUrl: t.flour,
        },
    ...
    {
      id: "seed-akwaaba-manchester-cheetham-hill",
      email: "orders+akwaaba.seed@clipservice.app",
      role: "Akwaaba Manchester",
      bio:
        `Akwaaba on Cheetham Hill Road keeps the welcome warm — fermented banku tubs beside smoky shito that stains spoons happily. Aunties skim fabric bolts for weddings while cousins hoard shea jars for Manchester winters.` +
        ` Cassava and plantain crates rotate fast because Sunday soup waits for nobody. Ordering through Clip honours the chatter you already trusted at the doorway; receipts summarise grams clearly for folks budgeting tram fare home.`,
      ...
      openingHours: `Cheetham Hill, Manchester · ${hours}`,
    ...
    {
      id: "seed-spice-route-manchester-levenshulme",
      email: "orders+spiceroute.seed@clipservice.app",
      role: "Spice Route Manchester",
      bio:
        `Levenshulme students and aunties collide over lemongrass bundles and tins of coconut milk labelled clearly for laksa Tuesdays. Jasmine rice sacks stack beside Lebanese za'atar tins because Stockport Road kitchens rarely stay monocultural.` +
      ...
      openingHours: `Levenshulme, Manchester · ${hours}`,
