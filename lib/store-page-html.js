...
body{margin:0;font-family:Inter,system-ui,sans-serif;color:var(--brown);background:var(--cream);line-height:1.45;min-height:100vh}
.pname-link{text-decoration:none;color:inherit}
.pname-link:hover{color:var(--terracotta)}
.pdetail-row{margin:-4px 0 10px;font-size:.8rem;font-weight:600}
.plink{color:var(--terracotta)}
