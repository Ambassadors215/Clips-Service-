import { incrementPwaMetric, incrementPwaDailyOpen, incrementWhatsAppMetric } from "../kv-store.js";
...
const ALLOWED = new Set([
  ...
  "wa_review_link_click",
  "wa_dashboard_from_whatsapp",
  "float_whatsapp_click",
]);
...
export default async function handler(req, res) {
  ...
  if (
    event === "wa_review_link_click" ||
    event === "wa_dashboard_from_whatsapp" ||
    event === "float_whatsapp_click"
  ) {
    try {
      await incrementWhatsAppMetric(event, 1);
