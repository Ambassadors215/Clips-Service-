...
export default function handler(req, res) {
  ...
  const xmlRawUrl = `${base}/blog/rss.xml?raw=1`;
...
<p class="blog-feed-note">Typing <code>/blog/rss.xml</code> in the address bar now opens this page automatically. The link you copy below is what feed readers use (Apple News, Feedly, etc.). Use <strong>Open raw feed</strong> only if you want to see the XML.</p>
...
<p class="blog-feed-actions"><a class="blog-cta" href="${esc(xmlRawUrl)}" target="_blank" rel="noopener">Open raw feed (XML)</a><a href="/blog">Back to blog</a></p></div></section></div>
<script>
