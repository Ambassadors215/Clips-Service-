...
import { BLOG_POSTS, categoriesUsedInPosts } from "../blog-data.js";
...
export default async function handler(req, res) {
  ...
  const staticUrls = [
    ...
    { loc: `${base}/market-stalls`, changefreq: "weekly", priority: "0.76" },
    { loc: `${base}/impact`, changefreq: "weekly", priority: "0.7" },
    { loc: `${base}/blog`, changefreq: "weekly", priority: "0.82" },
    { loc: `${base}/blog/feed`, changefreq: "weekly", priority: "0.55" },
  ];
  ...
  for (const cat of categoriesUsedInPosts()) {
    staticUrls.push({
      loc: `${base}/blog/category/${encodeURIComponent(cat)}`,
      changefreq: "weekly",
      priority: "0.76",
    });
  }
