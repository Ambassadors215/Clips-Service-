...
export default async function handler(req, res) {
  ...
  try {
    ...
    let traffic = null;
    try {
      traffic = await getSiteVisitTrafficMetrics();
    } catch {
      traffic = null;
    }
      ...
      trust: {
        ...
        ...(traffic
          ? {
              ...
              uniqueVisitors7d: traffic.uniqueVisitors7d,
              uniqueVisitors30d: traffic.uniqueVisitors30d,
            }
          : {}),
      },
      traffic,
