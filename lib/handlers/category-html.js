...
export default async function handler(req, res) {
  ...
  const listHtml = matched.length
    ? `<div style="display:grid;gap:14px;margin:24px 0">${matched
        ...
        .join("")}</div>`
    : `<p style="padding:18px;background:#faf6f2;border-radius:12px;border:1px dashed #c4b8a8"><strong>Coming soon — stores being onboarded.</strong> Browse <a href="/stores">all stores</a> or <a href="/store-owner">list your shop</a>.</p>`;
